  ...
  beforeEach(function () {
    ...
    angular.mock.inject(function (_$injector_) {
      Injections ={
        ...
        DataService: _$injector_.get('otusjs.studio.navigationBuilder.navigationRoutePriority.DataService'),
        GraphLayerService: _$injector_.get('otusjs.studio.navigationBuilder.GraphLayerService')
      };
      service = _$injector_.get('otusjs.studio.navigationBuilder.navigationRoutePriority.UiEventsService', Injections);
    });
