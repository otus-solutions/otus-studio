describe('UpdateFillingRulesEventFactory_Suite', function () {
  ...
  beforeEach(function () {
    ...
    angular.mock.inject(function (_$injector_) {
      ...
      factory = _$injector_.get('UpdateFillingRulesEventFactory', Injections);
  ...
  it('create_method_should_instantiate_UpdateFillingRulesEvent', function () {
