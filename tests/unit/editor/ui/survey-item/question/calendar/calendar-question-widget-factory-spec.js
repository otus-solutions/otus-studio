describe('CalendarQuestionWidgetFactory', function() {
    var Mock = {};
    var factory;
    ...
    beforeEach(function() {
        ...
        inject(function(_$injector_) {
            ...
            factory = _$injector_.get('CalendarQuestionWidgetFactory');
        });
    });
    ...
    describe('create method', function() {
        ...
        describe('Interface definition', function() {
            ...
            it('should create an object with getClassName method defined', function() {
                expect(widget.getClassName()).toEqual('CalendarQuestionWidget');
