describe('TimeQuestionWidgetFactory', function() {
    var Mock = {};
    var factory;
    ...
    beforeEach(function() {
        ...
        inject(function(_$injector_) {
            ...
            factory = _$injector_.get('TimeQuestionWidgetFactory');
        });
    });
    ...
    describe('create method', function() {
        ...
        describe('Interface definition', function() {
            ...
            it('should create an object with getClassName method defined', function() {
                expect(widget.getClassName()).toEqual('TimeQuestionWidget');
    ...
    function mockQuestion($injector) {
        Mock.question = $injector.get('SurveyItemFactory').create('TimeQuestion', 'Q1');
        return Mock.question;
    }
