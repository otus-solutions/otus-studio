describe('CheckboxQuestionWidgetFactory', function() {
    var Mock = {};
    var factory;
    ...
    beforeEach(function() {
        ...
        inject(function(_$injector_) {
            ...
            factory = _$injector_.get('CheckboxQuestionWidgetFactory');
        });
    });
    ...
    describe('create method', function() {
        ...
        describe('Interface definition', function() {
            ...
            it('should create an object with getClassName method defined', function() {
                expect(widget.getClassName()).toEqual('CheckboxQuestionWidget');
    ...
    function mockQuestion($injector) {
        Mock.question = $injector.get('SurveyItemFactory').create('CheckboxQuestion', 'Q1');
        return Mock.question;
    }
