describe('TextQuestionWidgetFactory', function() {
    var Mock = {};
    var factory;
    ...
    beforeEach(function() {
        ...
        inject(function(_$injector_) {
            ...
            factory = _$injector_.get('TextQuestionWidgetFactory');
        });
    });
    ...
    describe('create method', function() {
        ...
        describe('Interface definition', function() {
            ...
            it('should create an object with getClassName method defined', function() {
                expect(widget.getClassName()).toEqual('TextQuestionWidget');
    ...
    function mockQuestion($injector) {
        Mock.question = $injector.get('SurveyItemFactory').create('TextQuestion', 'Q1');
        return Mock.question;
    }
