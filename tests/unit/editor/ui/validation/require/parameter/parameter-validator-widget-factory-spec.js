xdescribe('ParameterValidatorWidgetFactory', function() {
    var Mock = {};
    var factory;
    var whoAmI;
    ...
    beforeEach(function() {
        ...
        inject(function(_$injector_) {
            ...
            factory = _$injector_.get('ParameterValidatorWidgetFactory');
        });

        widget = factory.create(Mock.scope, Mock.element);
    });

    describe('Start a parameter Factory Object', function() {
      it ('should return a parameter Validator Object', function() {
        pending();
      });
    ...
    describe('updates on data', function() {
      it('should model data value be equal to self value', function(){
        expect(Mock.question.fillingRules.options['parameter'].data.reference).toEqual(widget.data);
      });
    ...
    function mockQuestion($injector) {
        ...
        Mock.question.fillingRules.options['parameter'] = $injector.get('RulesFactory').create('parameter');
        return Mock.question;
    }
