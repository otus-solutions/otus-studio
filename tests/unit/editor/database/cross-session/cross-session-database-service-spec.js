...
//
//     xit('should call $indexedDB.openStore with name "survey_template"',
//       function() {
...
//       });
//
//     xit('should call store.upsert', function() {
//       spyOn(Mock.$indexedDB, 'openStore').and.callFake(function(
//         storeName, callback) {
//         callback(Mock.store);
//       });
//
//       service.saveSurveyTemplateRevision(Mock.template, jasmine.any(
//         Object));
//
//       expect(Mock.store.upsert).toHaveBeenCalledWith(jasmine.any(
//         Object));
//     });
//
