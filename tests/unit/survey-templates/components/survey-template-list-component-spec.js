xdescribe("component: surveyTemplateList", function() {
  ...
  beforeEach(inject(function($rootScope, _$componentController_,
    ...
    Mock.SurveyTemplateManagerService = _$injector_.get(
  ...
  describe("on $onInit phase", function() {
    beforeEach(function() {
      ...
      spyOn(ctrl.SurveyTemplateManagerService,
        "initializeSurveyTemplateList");

      ctrl.$onInit();
    });

    it(
      "should call SurveyTemplateManagerService.initializeSurveyTemplateList()",
      function() {
        expect(ctrl.SurveyTemplateManagerService.initializeSurveyTemplateList)
          .toHaveBeenCalled();
      });
  });
