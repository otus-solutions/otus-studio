describe("component: SurveyTemplateComponent", function() {
  ...
  beforeEach(inject(function(_$componentController_, _$injector_) {
    ...
    $httpBackend.when('GET',
      'app/dashboard/survey-templates/components/survey-template/survey-template.html'
    ).respond(TEMPLATE);
    SelectedSurveyTemplatesManagementService =
      mockSelectedSurveyTemplatesManagementService(_$injector_);
  ...
  describe("should be compiled with success", function() {
    ...
    xit("not working", function() {
      spyOn(SelectedSurveyTemplatesManagementService,
        'selectSurveyTemplate');
      compiledComponent.triggerHandler('click');
      expect(Mock.SelectedSurveyTemplatesManagementService.selectSurveyTemplate)
        .toHaveBeenCalled();
    });
  });
  ...
  function mockSelectedSurveyTemplatesManagementService(_$injector_) {
    Mock.SelectedSurveyTemplatesManagementService = _$injector_.get(
      'SelectedSurveyTemplatesManagementService');
