describe("SelectedSurveyTemplatesManagementService", function() {
    ...
    beforeEach(function() {
        ...
        inject(function(_$injector_) {
            service = _$injector_.get('SelectedSurveyTemplatesManagementService');
        });
    });
    ...
    describe("selectSurveyTemplate method", function() {
        ...
        it("should put a selected survey template in selectedSurveyTemplates", function() {
    ...
    describe("removeSurveyTemplate method", function() {
        ...
        it("should remove a selected survey template in selectedSurveyTemplates", function() {
    ...
    describe("hasOnlyOneSelectedSurveyTemplate method", function() {
        ...
        it("should return TRUE when the selectedSurveyTemplatesList contains only one template", function() {
            expect(service.hasOnlyOneSelectedSurveyTemplate()).toBe(true);
        });

        it("should return FALSE when the selectedSurveyTemplatesList contais more than one template", function() {
            service.selectSurveyTemplate(Mock.surveyTemplate_ONE);
